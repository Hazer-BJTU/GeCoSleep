...
parser.add_argument('--task_names', nargs='+', default=['ISRUC1', 'Sleep-EDF', 'MASS', 'SHHS'],
...
parser.add_argument('--alpha', type=float, nargs='?', default=0.1, help='coefficient of task loss')
